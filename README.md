...
This is a repository containing my notes and snippets as I'm learning the Rust programming language so, I can refer to these down the road.

The order of concepts is roughly the same as [The Rust Programming Language](https://doc.rust-lang.org/book/) book.
...
- [Structuring Related Data with Structs](https://github.com/I-Do-CS/rust-notes/tree/main/03.structs/structs.md)
- [Enums, Patterns & Matching](https://github.com/I-Do-CS/rust-notes/tree/main/04.enums/enums.md)
...
- [Miscellaneous Topics](https://github.com/I-Do-CS/rust-notes/tree/main/16.misc/misc.md)
