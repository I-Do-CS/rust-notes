...
Patterns and pattern matching are essential parts of rust and I'll cover them in more depth later; for now, think of patterns as Rust's special way of describing/understanding the shape of data. Once we describe tha shape of some data correctly, we can extract or bind it from/to variables and types.
